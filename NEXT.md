...
Actualizado el 2026-09-14 en la rama codex/xio-import-review. Esta nota
...
- `projects/rd-field/bridge/hub.py` es la autoridad del servidor de puente;
  `hub_remote.py` conserva el nombre histórico como alias, sin una segunda
  implementación. `XIO_MANIFEST.sha256` y la regresión del candidato reflejan
  esa reducción.
